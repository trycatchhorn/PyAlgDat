...
class TestDirectedGraph(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.e01_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v0_g2, self.v1_g1_g2)  # a -> b
        self.e02_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v0_g2, self.v2_g1_g2)  # a -> c
        self.e04_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v0_g2, self.v4_g1_g2)  # a -> e
        self.e13_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v1_g1_g2, self.v3_g1_g2)  # b -> d
        self.e14_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v1_g1_g2, self.v4_g1_g2)  # b -> e
        self.e27_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v2_g1_g2, self.v7_g2)  # c -> h
        self.e25_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v2_g1_g2, self.v5_g1_g2)  # c -> f
        self.e36_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v3_g1_g2, self.v6_g2)  # d -> g
        self.e46_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v4_g1_g2, self.v6_g2)  # e -> g
        self.e48_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v4_g1_g2, self.v8_g2)  # e -> i
        self.e47_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v4_g1_g2, self.v7_g2)  # e -> h
        self.e57_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v5_g1_g2, self.v7_g2)  # f -> h
        self.e68_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v6_g2, self.v8_g2)  # g -> i
        self.e78_g2 = graph_edge.DirectedGraphEdge(
            self.graph2, self.v7_g2, self.v8_g2)  # h -> i
    ...
    def test_directed_graph_get_vertices(self):
        ...
        s_list1 = sorted(tmp1, key=lambda vertex: (
            vertex.vertex_name, vertex.vertex_number))
        s_list2 = sorted(tmp2, key=lambda vertex: (
            vertex.vertex_name, vertex.vertex_number))
